...
// can also use !== but if and else values are reversed
...
function setWeather() {
	...
	function setBackgroundColor() {
		// Color screen based on a temperature
		if (temperature >= 15){
			// When referencing CSS properties in JS, use camelCase instead of dash

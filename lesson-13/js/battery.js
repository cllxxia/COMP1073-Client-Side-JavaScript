...
const chargeStatus = document.querySelector('#battery:first-of-type(1)');
// STEP 1b: Grab the <output> element inside the second <dd> element for displaying the battery charge level
const chargeLevel = document.querySelector('#battery:nth-of-type(2) output');
...
const chargeMeter = document.querySelector('#battery:nth-of-type(2) progress');
